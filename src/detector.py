...
class SimpleDetector(nn.Module):
    ...
    def forward(self,
        ...
        :param box_masks: [batch_size, max_num_objects] Mask for whether or not each box is OK
        :return: object reps [batch_size, max_num_objects, dim]
        """
        # [batch_size, 2048, im_height // 32, im_width // 32
        img_feats = self.backbone(images)
        box_inds = box_masks.nonzero()
        ...
        obj_reps = pad_sequence(roi_aligned_feats, box_masks.sum(1).tolist())
        return {
